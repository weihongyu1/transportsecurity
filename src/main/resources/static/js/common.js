...
CommonUtil.prototype.isBlank = function (str) {
    return typeof str =='undefined' || str==null || str+""=="";
}
CommonUtil.prototype.isNotBlank = function (str) {
    return !this.isBlank(str);
}
CommonUtil.prototype.isEmptyArr = function(arr){
    return typeof arr == 'undefined' || arr == null || arr.length<=0;
}
CommonUtil.prototype.existInArr = function (arr,item) {
...
CommonUtil.prototype.mapToKeyValue = function (map) {
...
CommonUtil.prototype.deleteFromArr = function (arr, deleteItem) {
...
CommonUtil.prototype.getParameter = function (name) {
...
CommonUtil.prototype.listToMap = function (fieldName, list) {
    var map = {}
...
CommonUtil.prototype.arrEqual = function (arr1, arr2) {
...
CommonUtil.prototype.combineArr = function (arr1, arr2) {
 ...
 * @param type :_blank
 */
CommonUtil.prototype.openUrl = function (url,type) {
    var tempWindow=window.open(type); // 先打开页面
    tempWindow.location=url; // 后更改页面地址
}
//el-上传文件组件 比较奇怪 不是动态的
CommonUtil.prototype.elUploadFileList = function (uploadFiles) {
    var arr = [];
...
CommonUtil.prototype.axios = function (_t,url,param,method,callback) {
    var _this = this;
    switch (method) {
        case 'get':
            axios({
...
CommonUtil.prototype.axiosThen = function(response,_t,callback){
    var _this = this;
    if(!response){
        _t.$message.error("网络异常");
        return;
...
CommonUtil.prototype.redirectToLoginPage = function () {
    window.location.href=this.frontCtx+'userinfo/login.html';
}

CommonUtil.prototype.isVariable = function (str) {
    var reg = /^[a-zA-Z][a-zA-Z0-9_]*$/g;
    var result = reg.test(str);
    return result;
}

CommonUtil.prototype.apiConstantTagClassMapping = function () {
    return {
...
CommonUtil.prototype.laytpl = function (template, renderObj) {
 ...
 * @param target _blank ''
 */
CommonUtil.prototype.openWindow = function(action,method,target,data){
    var form = $('form');
    form.html('')
    form.hide();
